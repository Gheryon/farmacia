...
<div class="modal fade" id="crear-lote" tabindex="-1" role="dialog" aria-labelledby="cambio-contrasena" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="card card-success">
        <div class="card-header">
        ...
        <div class="card-body">
          <div class="alert alert-success text-center" id='add-lote' style='display:none'>
              <span><i class="fas fa-check m-1"></i>Lote añadido</span>
          </div>
          <form id="form-crear-lote">
            ...
            <div class="form-group">
              ...
              <input id="stock" type="number" class="input form-control" placeholder="Introduce stock">
            </div>
            <div class="form-group">
              <label for="vencimiento">Vencimiento</label>
              <input id="vencimiento" type="date" class="input form-control" placeholder="Introduce vencimiento">
            </div>
