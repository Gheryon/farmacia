$(document).ready(function(){
  ...
  let datatable = $('#tabla-venta').DataTable({
    ...
    columns: [
      ...
      <button class="ver btn btn-success" title="Mostrar" type="button" data-toggle="modal" data-target="#vista-venta"><i class="fas fa-search"></i></button>
      <button class="btn btn-danger" title="Borrar"><i class="fas fa-window-close"></i></button>` }
    ],
    "language": espannol
    });
